...
class FGMembersite
{
    ...
    function UserFBId()
    {
        return isset($_SESSION['fb_id_of_user'])?$_SESSION['fb_id_of_user']:'';
    }

    function UserRiseUserId()
    {
        return isset($_SESSION['rise_user_id_of_user'])?$_SESSION['rise_user_id_of_user']:'';
    }
    ...
    function CheckLoginInDB($username,$password){
        ...
        //API Url
        $url = 'https://barclaysbotnode-thestinson.c9users.io/login';
        ...
        if($jsonResponse["status"] == "fail"){
            ...
            $_SESSION['name_of_user']  = $jsonResponse['first_name']." ".$jsonResponse['last_name'];
            $_SESSION['email_of_user'] = $jsonResponse['email'];
            $_SESSION['fb_id_of_user'] = $jsonResponse['asid'];
    ...
    public function checkhashSSHA($salt, $password) {
        ...
        $hash = base64_encode(sha1($password, true) . $salt);
